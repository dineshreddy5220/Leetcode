<h2>987. Vertical Order Traversal of a Binary Tree</h2><h3>Medium</h3><hr><div><p>Given a binary tree, return the <em>vertical order</em> traversal of its nodes&nbsp;values.</p>
